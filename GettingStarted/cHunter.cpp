...
void cHunter::GetTransform(glm::mat4& transform)
{

}


void cHunter::GetMeshEntry(sMeshEntry& meshEntry)
{
	meshEntry = renderingInfo.MeshEntry;
}

void cHunter::SetMeshEntry(sMeshEntry meshEntry)
{
	renderingInfo.MeshEntry = meshEntry;
}
void cHunter::GetColour(glm::vec4& colour)
{
	colour = renderingInfo.Color;
}
void cHunter::SetColour(glm::vec4 colour)
{
	renderingInfo.Color = colour;
}
void cHunter::GetMatrix(glm::mat4& modelMat)
{
	modelMat = renderingInfo.matrix;
}
void cHunter::SetMatrix(glm::mat4 modelMat)
{
	renderingInfo.matrix = modelMat;
}

void cHunter::SetPlayerReference(iEntity* player)
{
	playerRef = player;
}

void cHunter::GetNormal(glm::mat4& normal)
{
	normal = renderingInfo.normal;
}
void cHunter::SetNormal(glm::mat4 normal)
{
	renderingInfo.normal = normal;
}

void cHunter::Update(float deltaTime)
{
	...
	else if (mState == eEnemyState(STATE_PURSUE))
	{
		//Not looking at me
	...
	{
		renderingInfo.Color = glm::vec4(1.f, 1.f, 0.5f, 1.f);
...
void cHunter::Jump(float height)
{
	renderingInfo.matrix[3].y = height;
}

void cHunter::ExecuteCommand(cNameValuePair NVPair)
{
	//if (NVPair.name == "Jump")
	//{
...
void cHunter::SetSpeed(float newSpeed)
{
	monkeySpeed = newSpeed;
}

glm::vec3 cHunter::GetVelocity()
{
